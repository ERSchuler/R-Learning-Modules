...
```{r}
setwd("C:/Users/eschuler/Desktop/R MLM 2022/")
```
...
Where $n_c$ is the average number of responses within the cluster. If the design effect estimate is greater than 2.0, then MLM should be utilized (see: Muthén, 1991, 1994; Muthén & Satorra, 1989, 1995)
...
- Muthén, B., & Satorra, A. (1989). Multilevel aspects of varying parameters in structural models. In Multilevel analysis of educational data (pp. 87-99). Academic Press.
