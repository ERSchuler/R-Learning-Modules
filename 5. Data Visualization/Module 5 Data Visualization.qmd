...
In this module we will cover:
  - How to use visualizations as part of data screening
      - Box plots
      - Outlier detection (univariate) 
      - Standard scatter plots
      - Create a 3D scatter plot for three variables
  - Creating plots
      - Bar charts
      - Histograms
      - Line graphs
...
# Working Directory ----
We also need to tell R where to look for and save files. 
You can also do this from the "Session" Menu 
...
How to visualize data as part of the data screening Process 
     (or how I stopped worrying and trusted my gut)         
...
Let's do it a different way so outliers are labeled
  from: https://stackoverflow.com/questions/33524669/labeling-outliers-of-boxplots-in-r/33525389 
...
Step 1 run the helper function to store summary information (between groups)
...
from: https://rstudio-pubs-static.s3.amazonaws.com/177286_826aed2f00794640b301aeb42533c6f1.html 
Default colors
```{r}
